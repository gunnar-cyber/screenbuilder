...
export default class JsonHandler {
   ...
   */
  constructor(basePath: string, sourceLanguage: string = 'en') {
   ...
   */
  async readJson(filePath: string): Promise<Record<string, string>> {
    try {
   ...
   */
  async writeJson(filePath: string, data: Record<string, string>): Promise<void> {
    try {
